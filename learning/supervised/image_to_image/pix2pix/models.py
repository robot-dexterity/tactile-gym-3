...
def create_model(
    ...
    if 'pix2pix' in model_params['model_type']:
        generator = shPix2PixGeneratorUNet(**model_params['generator_kwargs']).to(device)
...
class pix2PixGeneratorUNet(nn.Module):
    def __init__(
        self,
        in_channels=1,
        out_channels=1,
        ...
        super(pix2PixGeneratorUNet, self).__init__()
...
class shPix2PixGeneratorUNet(nn.Module):
    def __init__(
        self,
        in_channels=1,
        out_channels=1,
        ...
        super(shPix2PixGeneratorUNet, self).__init__()
