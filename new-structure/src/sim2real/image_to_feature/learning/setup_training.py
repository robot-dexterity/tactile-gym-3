...
from utils.utils import load_json_obj, save_json_obj
...
def setup_model_labels(task_name, data_dirs, save_dir=None):
    ...
    target_label_names_dict = {
        ...
        'edge_2d': ['pose_z', 'shear_x', 'shear_y', 'shear_Rz'],
        'tapping_and_shearing': ['shear_x', 'shear_y'],
